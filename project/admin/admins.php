...
<section class="grid">
   ...
   <div class="box" style="text-align: center;">
      <p>Nouveau admin</p>
      <a href="register.php" class="btn">Ajouter</a>
   </div>
   ...
   <div class="box" <?php if( $fetch_admins['name'] == 'admin'){ echo 'style="display:none;"'; } ?>>
      <p>Nom complet : <span><?= $fetch_admins['name']; ?></span></p>
      <form action="" method="POST">
         <input type="hidden" name="delete_id" value="<?= $fetch_admins['id']; ?>">
         <input type="submit" value="Supprimer" onclick="return confirm('Voulez-vous supprimer cet administrateur?');" name="delete" class="btn">
      </form>
   </div>
   <?php
      }
